 ...
 * @author HP
 */
public class Transport_History extends javax.swing.JFrame {

    /**
     * Creates new form All_Customer
     */
    public Transport_History() {
        initComponents();
        currentTime();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Invoice No.", "Name", "Mobile No.", "Qty", "Amount", "Status", "Date"
            }
        ) {
        ...
        jLabel24.setText("Transport History");
        ...
        jPanel1.add(jPanel5, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 250, 810, 380));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Transport_History.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Transport_History().setVisible(true);
            }
        });
    }
